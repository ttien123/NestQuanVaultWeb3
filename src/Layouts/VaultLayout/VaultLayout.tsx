    ...
    return (
        <main className="bg-background_1 bg-lightBg bg-center bg-cover bg-no-repeat bg-fixed">
            <div className="flex relative z-10">
                <div className="hidden lg:block w-[310px] flex-[310px] flex-shrink-0 flex-grow-0 bg-[#070A14] px-6 pt-10 pb-8 relative z-10">
                ...
                <div className="flex-1 max-w-full lg:max-w-[calc(100vw-310px)]">{children}</div>
