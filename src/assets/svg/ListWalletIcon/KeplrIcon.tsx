const KeplrIcon = () => {
    return (
        <svg width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_2418_5059)">
                <mask
                    id="mask0_2418_5059"
                ...
                <g mask="url(#mask0_2418_5059)">
                    <path
                        ...
                        fill="url(#paint0_linear_2418_5059)"
                    />
                    <path
                        d="M37.5909 0.0976562H11.4091C5.38417 0.0976562 0.5 4.98183 0.5 11.0067V37.1885C0.5 43.2135 5.38417 48.0977 11.4091 48.0977H37.5909C43.6159 48.0977 48.5 43.2135 48.5 37.1885V11.0067C48.5 4.98183 43.6159 0.0976562 37.5909 0.0976562Z"
                        fill="url(#paint1_radial_2418_5059)"
                    />
                    <path
                        d="M37.5909 0.0976562H11.4091C5.38417 0.0976562 0.5 4.98183 0.5 11.0067V37.1885C0.5 43.2135 5.38417 48.0977 11.4091 48.0977H37.5909C43.6159 48.0977 48.5 43.2135 48.5 37.1885V11.0067C48.5 4.98183 43.6159 0.0976562 37.5909 0.0976562Z"
                        fill="url(#paint2_radial_2418_5059)"
                    />
                    <path
                        d="M37.5909 0.0976562H11.4091C5.38417 0.0976562 0.5 4.98183 0.5 11.0067V37.1885C0.5 43.2135 5.38417 48.0977 11.4091 48.0977H37.5909C43.6159 48.0977 48.5 43.2135 48.5 37.1885V11.0067C48.5 4.98183 43.6159 0.0976562 37.5909 0.0976562Z"
                        fill="url(#paint3_radial_2418_5059)"
                    />
                    <path
